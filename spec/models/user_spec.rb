...
describe User do
    ...
    describe "micropost associations" do
        ...
        describe "status" do
            ...
            before do
                ...
                3.times { followed_user.microposts.create!(content: "hoge fuga")}
            end
    ...
    describe "following" do
        ...
        describe "and unfollowing" do
            ...
            # thiese four codes have same meaning
            it { should_not be_following(other_user)}
            # this code doesn't work --> it { should_not following?(other_user)}
            it { expect(!@user.following?(other_user))}
            it { should_not subject.following?(other_user)}
            specify { subject.following?(other_user).should be_false}
            # over rspec3 should allow this syntax --> it { is_expected.not_to following?(other_user)}
